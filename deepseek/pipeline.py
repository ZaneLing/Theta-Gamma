...
from gamma import LLMClient
from theta import ThetaAgent
...
def ensure_deepseek_default() -> None:
    """
    如果未显式指定，默认使用 deepseek-r1:14b 和本地服务地址。
    """
    os.environ.setdefault("API_URL", "http://172.16.120.14:11434/api/generate")
    os.environ.setdefault("MODEL_NAME", "deepseek-r1:14b")
